    ...
    >
      ...
      >
        <div style={{display: "flex", flexWrap: "nowrap", overflowX: "auto", position: "relative"}}>
          ...
          <a href="/quan-ly/3215/lap-phieu-thu" className="item-menu">
            <div className="icon text-center">
              <img width="55px" src="/icons/menus/thu_tien.png"  alt="quan-ly-hoa-don"/>
            </div>
            <div className="key">
              <span className="title">
                <b>Tất cả hóa đơn</b>
          ...
          <a href="/quan-ly/3215/tat-ca-hop-dong" className="item-menu">
            <div className="icon text-center">
              <img
                width="55px"
                src="/icons/menus/report_customer_use.png" alt="quan-ly-hop-dong"
              />
            </div>
            <div className="key">
              <span className="title">
          ...
          <a href="/quan-ly/3215/quan-ly-dich-vu" className="item-menu">
            <div className="icon text-center">
              <img
                width="55px"
                src="/icons/menus/ghi_chu.png"
                className="" alt="quan-ly-dich-vu"
              />
            </div>
            <div className="key">
              <span className="title">
          ...
          <a href="/quan-ly/3215/tat-ca-khach-thue" className="item-menu">
            <div className="icon text-center">
              <img
                width="55px"
                src="/icons/menus/danh_sach_lien_he.png" alt="quan-ly-khach-thue"
              />
            </div>
            <div className="key">
              <span className="title">
          ...
          <a href="/quan-ly/3215/thu-chi-tong-ket" className="item-menu">
            <div className="icon text-center">
              <img width="55px" src="/icons/menus/thu_tien.png" alt="tong-ket"/>
            </div>
            <div className="key">
              <span className="title">
          ...
          <a href="/quan-ly/3215/cai-dat-nha-tro" className="item-menu">
            <div className="icon text-center">
              <img width="55px" src="/icons/menus/setting.png" alt="cai-dat"/>
            </div>
            <div className="key">
              <span className="title">
                <b>Cài đặt</b>
