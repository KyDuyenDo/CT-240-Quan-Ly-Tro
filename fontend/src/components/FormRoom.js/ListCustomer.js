  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <div className="item-feature d-flex align-items-center justify-content-between mb-2">
            <div className="info" style={{ flex: "1" }}>
              <h5>Duyen Do</h5>
              <div>0355-544-778</div>
              <div>
                <span
                  className="badge"
                  style={{ fontSize: "12px", backgroundColor: "#7dc242" }}
                >
                  Đại diên hợp đồng
                </span>
              </div>
            </div>
            <div className="btn-round btn-delete">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
